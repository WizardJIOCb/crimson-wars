...
const DEFAULT_SKILL_DEFS = {
  ...
  psi_blast: { id: 'psi_blast', name: 'Psi Blast', kind: 'active', rarity: 'epic', maxLevel: 6, weight: 0.55, cooldownMs: 8600, cooldownMulPerLevel: 0.07, radius: 760, radiusPerLevel: 48, damage: 54, damagePerLevel: 20, knockbackMul: 9.6, stunMs: 180, desc: 'Massive radial knockback blast' },
