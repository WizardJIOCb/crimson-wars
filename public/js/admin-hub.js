(function () {
  ...
  const PROP_COLORS = {
    ...
    shopping_cart_barricade: '#a96f4a',
    road_shack: '#8b6f4a',
    mall_block: '#3ea9a1',
    clinic_block: '#7fd3c5',
    ...
    abandoned_building: '#7c6653',
    abandoned_building_1: '#6f5c4d',
    abandoned_building_2: '#8a7868',
    abandoned_bus: '#b48a2c',
    abandoned_gas_station: '#b56b3b',
    cyberpunk_storefront: '#43b9b2',
    futuristic_barrier: '#9aa9b7',
    futuristic_police_vehicle: '#4f7fb8',
    futuristic_vending_machine: '#5cc8d7',
    glowing_twisted_tree: '#6fbf5f',
    gnarled_tree: '#51643d',
    haunted_house: '#6b5a70',
    industrial_facility: '#7f8a8c',
    industrial_factory: '#8b8175',
    military_ambulance: '#d8ded9',
    post_apocalyptic_car: '#b84e3f',
    ruined_sci_fi_facility: '#6f8495',
    ruined_storefront: '#8f6b5a',
    rusty_gas_station: '#a65f35',
    rusty_shopping_cart: '#9b7354',
    steampunk_reactor: '#b6a23f',
    toxic_waste_barrels: '#92c850',
    wrecked_police_car: '#536173',
  };
  const PROP_META = {
    ...
    shopping_cart_barricade: { label: 'Баррикада из тележек', w: 156, h: 78, hp: 64, destructible: true, explosive: false },
    ...
    abandoned_building: { label: 'Abandoned building', w: 340, h: 260, hp: 1, destructible: false, explosive: false },
    abandoned_building_1: { label: 'Abandoned building B', w: 360, h: 280, hp: 1, destructible: false, explosive: false },
    abandoned_building_2: { label: 'Abandoned building C', w: 380, h: 300, hp: 1, destructible: false, explosive: false },
    abandoned_bus: { label: 'Abandoned bus', w: 194, h: 78, hp: 184, destructible: true, explosive: true },
    abandoned_gas_station: { label: 'Abandoned gas station', w: 520, h: 300, hp: 1, destructible: false, explosive: false },
    cyberpunk_storefront: { label: 'Cyberpunk storefront', w: 520, h: 240, hp: 1, destructible: false, explosive: false },
    futuristic_barrier: { label: 'Futuristic barrier', w: 140, h: 48, hp: 116, destructible: true, explosive: false },
    futuristic_police_vehicle: { label: 'Futuristic police vehicle', w: 124, h: 70, hp: 96, destructible: true, explosive: false },
    futuristic_vending_machine: { label: 'Futuristic vending machine', w: 78, h: 112, hp: 80, destructible: true, explosive: false },
    glowing_twisted_tree: { label: 'Glowing twisted tree', w: 160, h: 180, hp: 1, destructible: false, explosive: false },
    gnarled_tree: { label: 'Gnarled tree', w: 150, h: 170, hp: 1, destructible: false, explosive: false },
    haunted_house: { label: 'Haunted house', w: 430, h: 330, hp: 1, destructible: false, explosive: false },
    industrial_facility: { label: 'Industrial facility', w: 560, h: 300, hp: 1, destructible: false, explosive: false },
    industrial_factory: { label: 'Industrial factory', w: 620, h: 320, hp: 1, destructible: false, explosive: false },
    military_ambulance: { label: 'Military ambulance', w: 128, h: 72, hp: 112, destructible: true, explosive: true },
    post_apocalyptic_car: { label: 'Post-apocalyptic car', w: 108, h: 64, hp: 82, destructible: true, explosive: true },
    ruined_sci_fi_facility: { label: 'Ruined sci-fi facility', w: 540, h: 320, hp: 1, destructible: false, explosive: false },
    ruined_storefront: { label: 'Ruined storefront', w: 500, h: 240, hp: 1, destructible: false, explosive: false },
    rusty_gas_station: { label: 'Rusty gas station', w: 540, h: 310, hp: 1, destructible: false, explosive: false },
    rusty_shopping_cart: { label: 'Rusty shopping cart', w: 156, h: 78, hp: 64, destructible: true, explosive: false },
    steampunk_reactor: { label: 'Steampunk reactor', w: 436, h: 256, hp: 1, destructible: false, explosive: false },
    toxic_waste_barrels: { label: 'Toxic waste barrels', w: 180, h: 150, hp: 160, destructible: true, explosive: true },
    wrecked_police_car: { label: 'Wrecked police car', w: 112, h: 66, hp: 88, destructible: true, explosive: false },
  ...
  const ZOMBIE_BREAKABLE_PROP_HP = {
    ...
    hellmart_24_7: 740,
    abandoned_building: 420,
    abandoned_building_1: 460,
    abandoned_building_2: 500,
    abandoned_gas_station: 620,
    cyberpunk_storefront: 620,
    haunted_house: 680,
    industrial_facility: 720,
    industrial_factory: 780,
    ruined_sci_fi_facility: 780,
    ruined_storefront: 560,
    rusty_gas_station: 640,
    steampunk_reactor: 620,
