...
const MAP_PROP_DIRECTIONAL_SPRITES = Object.freeze(Object.fromEntries([
  ...
  src: `${TRIPO_MAP_PROP_ROOT}/${key}_directions.png`,
  frames: 8,
  columns: 4,
  angleOffset: 0,
  direction: 1,
...
const sprites = {
  ...
  mapProps: {
    ...
    build_1: loadImage(`${TRIPO_MAP_PROP_ROOT}/build_1.png`),
    build_2: loadImage(`${TRIPO_MAP_PROP_ROOT}/build_2.png`),
    build_3: loadImage(`${TRIPO_MAP_PROP_ROOT}/build_3.png`),
    build_4: loadImage(`${TRIPO_MAP_PROP_ROOT}/build_4.png`),
    build_5: loadImage(`${TRIPO_MAP_PROP_ROOT}/build_5.png`),
    build_6: loadImage(`${TRIPO_MAP_PROP_ROOT}/build_6.png`),
    build_7: loadImage(`${TRIPO_MAP_PROP_ROOT}/build_7.png`),
    abandoned_building: loadImage(`${TRIPO_MAP_PROP_ROOT}/abandoned_building.png`),
    abandoned_building_1: loadImage(`${TRIPO_MAP_PROP_ROOT}/abandoned_building_1.png`),
    abandoned_building_2: loadImage(`${TRIPO_MAP_PROP_ROOT}/abandoned_building_2.png`),
    abandoned_gas_station: loadImage(`${TRIPO_MAP_PROP_ROOT}/abandoned_gas_station.png`),
    cyberpunk_storefront: loadImage(`${TRIPO_MAP_PROP_ROOT}/cyberpunk_storefront.png`),
    futuristic_barrier: loadImage(`${TRIPO_MAP_PROP_ROOT}/futuristic_barrier.png`),
    futuristic_vending_machine: loadImage(`${TRIPO_MAP_PROP_ROOT}/futuristic_vending_machine.png`),
    glowing_twisted_tree: loadImage(`${TRIPO_MAP_PROP_ROOT}/glowing_twisted_tree.png`),
    gnarled_tree: loadImage(`${TRIPO_MAP_PROP_ROOT}/gnarled_tree.png`),
    haunted_house: loadImage(`${TRIPO_MAP_PROP_ROOT}/haunted_house.png`),
    industrial_facility: loadImage(`${TRIPO_MAP_PROP_ROOT}/industrial_facility.png`),
    industrial_factory: loadImage(`${TRIPO_MAP_PROP_ROOT}/industrial_factory.png`),
    ruined_sci_fi_facility: loadImage(`${TRIPO_MAP_PROP_ROOT}/ruined_sci_fi_facility.png`),
    ruined_storefront: loadImage(`${TRIPO_MAP_PROP_ROOT}/ruined_storefront.png`),
    rusty_gas_station: loadImage(`${TRIPO_MAP_PROP_ROOT}/rusty_gas_station.png`),
    rusty_shopping_cart: loadImage(`${TRIPO_MAP_PROP_ROOT}/rusty_shopping_cart.png`),
    steampunk_reactor: loadImage(`${TRIPO_MAP_PROP_ROOT}/steampunk_reactor.png`),
    toxic_waste_barrels: loadImage(`${TRIPO_MAP_PROP_ROOT}/toxic_waste_barrels.png`),
    futuristic_police_vehicle: loadImage(`${TRIPO_MAP_PROP_ROOT}/futuristic_police_vehicle.png`),
    post_apocalyptic_car: loadImage(`${TRIPO_MAP_PROP_ROOT}/post_apocalyptic_car.png`),
    wrecked_police_car: loadImage(`${TRIPO_MAP_PROP_ROOT}/wrecked_police_car.png`),
  },
